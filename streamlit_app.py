...
# Streamlit UI
st.set_page_config(page_title="Potato Quality Classifier", page_icon="🥔")

st.title("Potato Quality Classifier 🥔")
st.write("Unggah gambar kentang untuk memprediksi apakah gambar tersebut adalah kentang atau bukan, dan jika itu adalah kentang, jenis kentangnya akan diprediksi.")

uploaded_file = st.file_uploader("Pilih file gambar", type=["jpg", "jpeg", "png"])

if uploaded_file is not None:
    image = Image.open(uploaded_file)
    st.image(image, caption='Gambar yang diunggah.', use_column_width='auto', width=300)
